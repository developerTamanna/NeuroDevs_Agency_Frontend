...
const WebDev = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 bg-gradient-to-b from-[#E0F3FF] to-white dark:from-[#1e293b] dark:to-[#0f172a] text-gray-900 dark:text-white"
    >
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    {services[activeService].features.map((feature, idx) => (
                      ...
                      >
                        <div
                          className={`w-8 h-8 bg-${services[activeService].bgColor}-100 text-${services[activeService].bgColor}-600 rounded-full flex items-center justify-center mr-3`}
                        >
